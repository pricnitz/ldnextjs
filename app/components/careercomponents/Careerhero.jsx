            ...
            <div className='max-w-6xl mx-auto py-10 md:py-20 md:px-4 px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
                <div className='lg:col-span-2 flex justify-between'>
                    <div className=' w-full'>
                        ...
                        <div className='mt-4'>
                            <Accordion items={[
                                { title: 'Frontend Developer', content: 'Job description for Frontend Developer' },
                                { title: 'Backend Developer', content: 'Job description for Backend Developer' },
                                { title: 'Fullstack Developer', content: 'Job description for Fullstack Developer' },
                            ]} />
                        </div>
