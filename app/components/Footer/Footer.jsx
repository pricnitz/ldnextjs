                    ...
                    <div className="grid md:grid-rows-3 grid-cols-1 gap-1 md:my-0 my-10">
                        ...
                        <div className="row-span-1 flex flex-col gap-1 my-auto md:justify-start justify-center md:items-start items-center md:text-start text-center md:px-10 px-0">
                            <div className="flex gap-1 my-auto justify-start text-gray-100 ">
                                <Link className="text-white md:text-red-600 text-bold" href="/career">Career</Link> | <Link className="text-white md:text-red-600 text-bold" href="/blogs">Blogs</Link> | <Link className="text-white md:text-red-600 text-bold" href="/#services">Services</Link> | <Link className="text-white md:text-red-600 text-bold" href="/#sitemap">Sitemap</Link> | <Link className="text-white md:text-red-600 text-bold" href="/faq">Faq</Link>
                            </div>
