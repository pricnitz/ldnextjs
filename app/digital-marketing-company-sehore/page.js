...
import { digitalmarketingcompanysehoretitle, digitalMarketingCompanySehore } from "../data";
...
import { digitalmarketingcompanysehoreseo } from "../seo";

export const metadata = digitalmarketingcompanysehoreseo;


export default function Page() {
    const data = digitalMarketingCompanySehore;

    return (
        <main className="w-full mx-auto bg-primary pt-20">
            {/* Header + Navbar */}
            <div className="fixed inset-x-0 top-0 z-50">
                <Header data={digitalmarketingcompanysehoretitle} />
                <Navbar />
            </div>
            ...
            <section className="max-w-6xl mx-auto px-4 pb-16">
              ...
              Why Choose Us as Your <span className="text-white">Sehore Digital Marketing Agency</span>
                </h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {[
                        ...
                        "✓ 5+ Years Local Market Expertise ",
                        "✓ Affordable Packages for Sehore SMEs"
                    ].map((item, idx) => (
                        <div
                            key={idx}
