...
import { digitalmarketingcompanyhoshangabadtitle, digitalMarketingCompanyHoshangabad } from "../data";
...
import { digitalmarketingcompanyhoshangabadseo } from "../seo";

export const metadata = digitalmarketingcompanyhoshangabadseo;

export default function Page() {
    const data = digitalMarketingCompanyHoshangabad;

    return (
        <main className="w-full mx-auto bg-primary pt-20">
            {/* Header + Navbar */}
            <div className="fixed inset-x-0 top-0 z-50">
                <Header data={digitalmarketingcompanyhoshangabadtitle} />
                <Navbar />
            </div>
            ...
            <section className="max-w-6xl mx-auto px-4 pb-16">
             ...
             Why Hoshangabad Businesses Choose Us<span className="text-white"></span>
                </h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {[
                        ...
                        "✓  Dedicated Hoshangabad Account Managers",
